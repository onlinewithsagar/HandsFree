      ...
      <header className="border-b border-white/10 bg-black/40 backdrop-blur-2xl sticky top-0 z-40">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link
              href="/#book"
              className="hidden sm:inline-flex px-4 py-2 bg-[#B8FF00] hover:bg-[#A3E600] text-black text-xs font-bold rounded-full transition-all items-center gap-1.5 shadow-lg shadow-[#B8FF00]/25"
            >
