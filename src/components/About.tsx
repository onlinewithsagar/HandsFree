    ...
    <section id="about" className="py-24 bg-slate-50 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          >
            <div className="relative w-72 h-72 sm:w-96 sm:h-96 rounded-full bg-gradient-to-tr from-blue-600 via-blue-500 to-cyan-400 p-1 shadow-2xl shadow-blue-500/30 flex items-center justify-center animate-pulse">
              <div className="w-full h-full rounded-full bg-slate-950 flex items-center justify-center relative overflow-hidden">
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(0,87,255,0.4)_0%,transparent_70%)]"></div>
                <svg viewBox="0 0 100 100" className="w-32 h-32 relative z-10" fill="none">
